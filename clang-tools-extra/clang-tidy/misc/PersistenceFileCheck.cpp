//===--- PersistenceFileCheck.cpp - clang-tidy --------------------------===//
//
...
void PersistenceFileCheck::registerMatchers(MatchFinder *Finder) {
...
void PersistenceFileCheck::check(const MatchFinder::MatchResult &Result) {
